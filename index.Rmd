...
See results here: <https://jsternin.github.io/PracticalMachineLearning>
...
There's no need to use multiple methods to improve it. Training control use crossvaldation method splitting training set into 3 files. We plot 10 most important factors in each of 6 classes.
